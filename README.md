...
## Description
* The Game has 5 levels, timer and a reset current level button. On completion a modal pops up displaying information about the time passed to complete the level, current level score and total score. The player can reset the level or click next level button.
